...
class MessageServiceTest extends AbstractIntegrationTest {
    ...
    void sendMessage() throws ChatException, UserException, MessageException {
        ...
        Message message = messageService.sendMessage(vaderAndLukesChatId, content, List.of(), vadersId);
        ...
        assertThrows(UserException.class, () -> messageService.sendMessage(vaderAndLukesChatId, content, List.of(), notExistingId));

        // Message to non-existing chat
        assertThrows(ChatException.class, () -> messageService.sendMessage(notExistingId, "Should not work", List.of(), lukesId));
    }
